...
<body>
<form action="/plan/place" method="post">
	<main>
		...
		<div class="d-flex flex-column flex-shrink-0 bg-light"
			...
			<a href="/" class="d-block p-3 link-dark text-decoration-none"
				...
				<svg class="bi" width="40" height="32">
					<use xlink:href="#bootstrap" /></svg> <span class="visually-hidden">Icon-only</span>
			</a>
			<ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
				<li class="nav-item"><a href="#link1" class="step1">STEP1<br>날짜
						확인
				</a> <!--  <a href="#" class="nav-link active py-3 border-bottom" aria-current="page" title="Home" data-bs-toggle="tooltip" data-bs-placement="right">
          <svg class="bi" width="24" height="24" role="img" aria-label="Home"><use xlink:href="#home"/></svg>
        </a> 메뉴바 1번째 칸~--></li>
				<li><a href="#link2" class="step2">STEP2<br>장소 선택
				</a> <!-- <a href="#" class="nav-link py-3 border-bottom" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right">
          <svg class="bi" width="24" height="24" role="img" aria-label="Dashboard"><use xlink:href="#speedometer2"/></svg>
        </a> 메뉴바 2번째 칸--></li>
				<li><a href="#link3" class="step3">STEP3<br>숙소 설정
				</a> <!-- <a href="#" class="nav-link py-3 border-bottom" title="Orders" data-bs-toggle="tooltip" data-bs-placement="right">
          <svg class="bi" width="24" height="24" role="img" aria-label="Orders"><use xlink:href="#table"/></svg>
				...
				<li><a href="#" class="nav-link py-3 border-bottom"
					title="Products" data-bs-toggle="tooltip" data-bs-placement="right">
				...
				<input type="hidden" name="areaname" value="${areaname}">
					<div class="makePlan"></div>
				</form>
				<a href="#" class="nav-link py-3 border-bottom"
					title="Customers" data-bs-toggle="tooltip"
					data-bs-placement="right"> <svg class="bi" width="24"
		...
		<div id="day">
			...
			<div
				...
				<div class="timeSetter">
					<h6>여행시간 상세설정</h6>
					<label class="selectDayBtn" for="modal-toggle"><input
						type="text" class="totalTime" value="총시간" readonly="readonly"
						style="border: none; width: 300px;"><br> 일정 수정하기</label> <br>
					<p class="set">일자</p>
					<ul class="timeset">
						<ins class="date2"></ins>
					</ul>
			...
			<div class="modal-container">
				<input id="modal-toggle" type="checkbox"> <label
					class="modal-backdrop" for="modal-toggle"></label>
		...
		<div id="place">
			<div
				...
				<div id="infowindow-content">
					<img src="" width="16" height="16" id="plage-icon"> <span
				...
				<div class="list-group list-group-flush border-bottom scrollarea">
					<c:forEach var="content" items="${list}">
						<div
							...
							<hr>
							<b><button class="contentNameBtn" style="width: 100px;"
									data-content-id="${content.content_id}">${content.content_id}</button></b>
							<input class="contentType" type="text"
								data-content-type="${content.contentType}"
								value="${content.contentType}" readonly="readonly"> <br>
							<input id="addr2" class="contentAdd" type="text"
								data-content-addr2="${content.addr2}" value="${content.addr2}"
								readonly="readonly">
		...
		<div id="place2" class="flex-shrink-0 p-3 bg-white"
			style="width: 350px;">
			<a href="/"
				class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
				<svg class="bi me-2" width="30" height="24"
					style="margin-top: 15px;">
					<use xlink:href="#bootstrap" /></svg> <span id="totalRunTime"></span>
			</a>
			<div class="chooseContent" style="border: 1px;"></div>
		</div>
					...
					<c:forEach var="content" items="${sleep}">
						<div
							...
							<c:if test="${content.contentType == '숙소'}">
								...
								<input class="contentType" type="text"
									data-content-type="${content.contentType}"
									value="${content.contentType}" readonly="readonly">
								<br>
								<input id="addr2" class="contentAdd" type="text"
									data-content-addr2="${content.addr2}" value="${content.addr2}"
									readonly="readonly">
		...
		<div id="sleep2" class="flex-shrink-0 p-3 bg-white"
			style="width: 350px;">
			<a href="/"
				class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
				<svg class="bi me-2" width="30" height="24"
				...
				style="margin-top: 5px; padding-top: 10px;">숙소 선택 </span> <span
				class="fs-5 fw-semibold" id="daysdiff"
				style="margin-top: 5px; padding-top: 10px;"></span>
			</a>
			<div class="chooseSleep" style="border: 1px;"></div>
		</div>
		<!-- 숙소 선택End -->
		<!-- 숙소 선택End -->
		<!-- 숙소 선택End -->
				...
				<div class="modal-content">
					...
					<div class="modal-header">
						<h4 class="modal-title">
							<input name="contentName" value="contentName" readonly="readonly"
								style="border: none;">
						</h4>
					...
					<div class="modal-body">
						<input name="contentType" value="contentType" readonly="readonly"
							style="border: none;"><br> <input name="contentAdd"
							value="contentAdd" readonly="readonly" style="border: none;">
					</div>
		...
		<div>
			<div id="googleMap"
				style="position: absolute; display: inline-block; width: 80%; height: 100%;"></div>
		</div>
	</main>
	
	<input type="hidden" name="areaname" value="${areaname}">
	<input type="hidden" name="content_id" value="${content.content_id}">
	<input type="hidden" name="go" value="${content.content_id}">
	<input type="hidden" name="end" value="${content.content_id}">
	<input type="hidden" name="time" value="${content.content_id}">
